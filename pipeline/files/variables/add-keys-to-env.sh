...
# On your linux host - Run with
#      $(basename $0) "/pipeline/${bamboo_application}-${bamboo_branch}-${bamboo_buildNumber}/" /etc/profile.d/ssm_param_context.sh
#
# Locally, to test
# e.g. ./add_keys_to_env.sh "/pipeline/qm-develop-6/" ./env.txt && cat /tmp/env.sh
